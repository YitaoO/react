...
var MapMain = (_dec = (0, _index3.connect)(function (_ref) {
  ...
  function MapMain() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = MapMain.__proto__ || Object.getPrototypeOf(MapMain)).call.apply(_ref2, [this].concat(args))), _this), _this.$usedState = ["type"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(MapMain, [{
    ...
    value: function _createData() {
      ...
      var type = this.__props.map.type;
